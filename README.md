...
メインターゲットのペルソナを30〜40代男性に設定し、中でも、「シンプルなゲームを好み」、「電車の中など、ちょっとした空き時間に遊びたい方」を対象としております。  
　シンプルなゲームは多数ありますが、ユーザー登録やアプリのダウンロードなど、ゲームプレイ以外のプロセスが必要なゲームが多く、昔の気軽に遊びやすいブラウザゲームを楽しみたい方は多いと考えました。
...
![](2020-11-23-14-35-19.png)
<i>（左：ゲーム開始時画面　右：クリア後画面）  </i>
...
![](2020-11-23-14-35-49.png)
<i>（左：一手目でゲームオーバーになる例　右：はじめの第一歩機能の例）  </i>

![](2020-11-23-14-36-13.png)
<i>（どんぐりの数の示唆機能）  </i>
...
s（Ruby on Railsのバージョン6.0.0で作成しています。）
1. 任意のディレクトリを開きます。vv
